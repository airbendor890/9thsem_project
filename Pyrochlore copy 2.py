        ...
        for n2 in [-1,0,1]:
            for n3 in [-1,0,1]:
                for alpha in range(1,5):
                    A = -(J_mn(3,3, gamma, n1, n2, n3, alpha, Theta_s[gamma-1], Phi_s[gamma-1], Theta_s[alpha-1], Phi_s[alpha-1]) + J_mn(3,3, alpha, -n1, -n2, -n3, gamma, Theta_s[alpha-1], Phi_s[alpha-1], Theta_s[gamma-1], Phi_s[gamma-1]))*KD(beta, gamma)
                    B = (J_mn(1j,1j, gamma, n1, n2, n3, alpha, Theta_s[gamma-1], Phi_s[gamma-1], Theta_s[alpha-1], Phi_s[alpha-1]) + J_mn(1j,1j, alpha, -n1, -n2, -n3, gamma, Theta_s[alpha-1], Phi_s[alpha-1], Theta_s[gamma-1], Phi_s[gamma-1]))*KD(beta, alpha)*KD(n1,0)*KD(n2,0)*KD(n3,0)
                    C = (J_mn(-1j,-1j, gamma, n1, n2, n3, alpha, Theta_s[gamma-1], Phi_s[gamma-1], Theta_s[alpha-1], Phi_s[alpha-1]) + J_mn(-1j,-1j, alpha, -n1, -n2, -n3, gamma, Theta_s[alpha-1], Phi_s[alpha-1], Theta_s[gamma-1], Phi_s[gamma-1]))*KD(beta, alpha)*KD(n1,0)*KD(n2,0)*KD(n3,0)
                    D = (J_mn(1j,-1j, gamma, n1, n2, n3, alpha, Theta_s[gamma-1], Phi_s[gamma-1], Theta_s[alpha-1], Phi_s[alpha-1]) + J_mn(1j,-1j, alpha, -n1, -n2, -n3, gamma, Theta_s[alpha-1], Phi_s[alpha-1], Theta_s[gamma-1], Phi_s[gamma-1]))*KD(beta, alpha)*KD(n1,0)*KD(n2,0)*KD(n3,0)
                    E = (J_mn(-1j,1j, gamma, n1, n2, n3, alpha, Theta_s[gamma-1], Phi_s[gamma-1], Theta_s[alpha-1], Phi_s[alpha-1]) + J_mn(-1j,1j, alpha, -n1, -n2, -n3, gamma, Theta_s[alpha-1], Phi_s[alpha-1], Theta_s[gamma-1], Phi_s[gamma-1]))*KD(beta, alpha)*KD(n1,0)*KD(n2,0)*KD(n3,0)
                    sum += A + B + C + D + E
    return sum
    ...
    if(beta!=gamma):
        ...
        for n1 in [-1,0,1]:
            for n2 in [-1,0,1]:
                for n3 in [-1,0,1]:
                    for alpha in range(1,5):
                        sum += 1j*(J_mn(1j,3, gamma, n1, n2, n3, alpha, Theta_s[gamma-1], Phi_s[gamma-1], Theta_s[alpha-1], Phi_s[alpha-1]) + J_mn(3,1j, alpha, -n1, -n2, -n3, gamma, Theta_s[alpha-1], Phi_s[alpha-1], Theta_s[gamma-1], Phi_s[gamma-1]) - J_mn(-1j,3, gamma, n1, n2, n3, alpha, Theta_s[gamma-1], Phi_s[gamma-1], Theta_s[alpha-1], Phi_s[alpha-1]) - J_mn(3,-1j, alpha, -n1, -n2, -n3, gamma, Theta_s[alpha-1], Phi_s[alpha-1], Theta_s[gamma-1], Phi_s[gamma-1]))
        return sum

def Hessian_Check(Theta_s, Phi_s):
    H = np.zeros((8,8), dtype=np.csingle)
    for alpha in range(4):
        for beta in range(4): 
            H[alpha][beta] = Theta_Theta_2nd_Diff(alpha+1, beta+1, Theta_s, Phi_s)
            H[alpha][beta+4] = Theta_phi_2nd_Diff(alpha+1, beta+1, Theta_s, Phi_s)
            H[alpha+4][beta] = Theta_phi_2nd_Diff(beta+1, alpha+1, Theta_s, Phi_s)
    # for i in range(8):
    #     for j in range(8):
